    ...
    for step in range(-117,-11):
        ...
        if modify_flag in ['del bbox', 'recovery bbox', 'add bbox', 'kps crop', 'real del bbox', 'add kps', 'check crop']:
            ...
            if modify_flag == 'kps crop':
                ...
                extra_trackId_list=[1435,1612,2446,1587,194,1438,531,2334,448,1635,
    1360,1113,667,2196,1429,881,819,1736,892,797,
    891,193,1602,1597,1476,138,1137,1155,1372,1551,
    1291,1411,1094,528,913,2311,601,478,2209,252,
    1441,424,1642,530,1647,1427,2179,409,562,1087,
    2074,1227,798,2287,546,14,997,2280,1610,3,
    770,195,2200,604,976,2324,439,2379,443,2388,
    2351,1226,983,1444,982,1407,821,441,2369,2352,
    169,1545,457,2181,2281,1706,504,2433,1490,1439,
    389,2309,2180,652,2301,1141,1112,835,833,2377,
    822,534,619,460,2279,1520,2381,621,657,1737,
    616,550,2346,1437,1253,1611,1593,661,2190,38,
    606,1133,347,1992,2434,1270,1509,1469,2432,1059,
    2085,1014,995,2263,2260,2424,2394,354,2390,2193,
    55,2360,464]
            ...
            if track_data is not None:
                ...
                copy_command = 'copy ' + os.path.join(json_base, trackName) + ' ' + os.path.join(back_up_save_path,
                                                                                                 trackName)
                # print(copy_command)
